...
$app->group('', function() use ($app, $container) {
    $app->group('/user', function() use ($app, $container) {
        ...
        // user get all item
        $this->get('/item/list/all', '\App\Controllxers\ItemController:getAllItemUser')->setname('all_item_user');
    ...
    $app->group('/admin', function() use ($app, $container)  {
        ...
        $app->group('/user', function(){
            ...
            $this->post('/adduser', 'App\Controllers\UserController:createUser')->setname('user.create');
            $this->put('/update/{id}', 'App\Controllers\UserController:updateUser')->setname('user.update');
